...
export function GoalChecklist() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-sm">
      <div
        aria-hidden
        className="absolute -inset-8 -z-10 rounded-[2.5rem] bg-primary/10 blur-3xl"
      />
        ...
        <ul className="flex flex-col">
          {goals.map((goal, i) => (
            ...
            >
              ...
              <motion.span
                initial={{ backgroundColor: "#FFFFFF", borderColor: "#E5E7EB" }}
                animate={{ backgroundColor: "#7ED321", borderColor: "#7ED321" }}
                transition={{
